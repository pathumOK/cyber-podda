...
SUDO: process.env.SUDO === undefined ? '94778716913,9363636367' : process.env.SUDO,
SESSION_NAME: process.env.PORT === undefined ? "PODDA" : process.env.SESSION_NAME,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , I am alive now!! Deploy With ⭕P⃯ᴏᴅᴅ⃑͢ᴀ│x 🐼🍎*" : process.env.ALIVE_MSG,
